...
> TODO: Set the test runner and commands for this project (e.g. Vitest/Jest/pytest)
> and the exact boundary modules to mock (data-access helper, `fetch`/HTTP client).
